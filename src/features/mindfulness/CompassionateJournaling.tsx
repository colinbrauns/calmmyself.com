...
const STEPS: JournalStep[] = [
  ...
  },
  {
    ...
    description:
      "Capture any looping thoughts, worries, or stories your mind is telling.",
    placeholder: "My mind keeps saying...",
  },
  {
    label: "What would you say to a close friend?",
    description:
      "Let that kinder voice speak to you as well, even if just a little.",
        ...
        <CardContent className="text-center py-10 space-y-5">
          ...
          >
            ...
            <p className="mt-2 text-sm">
              You don&apos;t need to get this perfect. The goal was simply to
              get things out of your head and offer even a small dose of
              compassion.
            </p>
          </motion.div>
      ...
      <CardContent className="space-y-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <textarea
              rows={4}
              className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 placeholder-gray-400 dark:placeholder-gray-500 text-sm focus:ring-2 focus:ring-rose-400 focus:border-rose-400"
