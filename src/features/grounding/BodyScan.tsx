...
const BODY_PARTS: BodyPart[] = [
  {
    ...
    name: "Top of Head",
    instruction:
      "Notice any sensations at the crown of your head. Warmth, coolness, tingling, or nothing at all.",
    duration: 15000,
  },
  {
    id: "face",
    name: "Forehead & Eyes",
    instruction:
      "Feel your forehead and the area around your eyes. Are they relaxed or tense?",
    duration: 15000,
  },
  {
    id: "jaw",
    name: "Jaw & Mouth",
    instruction:
      "Notice your jaw and mouth. Let them soften if they feel tight.",
    duration: 15000,
  },
  {
    id: "neck",
    name: "Neck & Throat",
    instruction:
      "Scan your neck and throat area. Breathe into any tension you find.",
    duration: 15000,
  },
  {
    id: "shoulders",
  ...
  },
  {
    ...
    name: "Arms & Hands",
    instruction:
      "Scan down your arms to your fingertips. Notice temperature, tingling, or heaviness.",
    duration: 20000,
  },
  {
    id: "chest",
    name: "Chest & Heart",
    instruction:
      "Feel your chest rise and fall. Notice your heartbeat and any emotions present.",
    duration: 20000,
  },
  {
    id: "stomach",
  ...
  },
  {
    ...
    name: "Lower Back",
    instruction:
      "Scan your lower back. Send breath to any areas of tension or discomfort.",
    duration: 15000,
  },
  {
    id: "hips",
  ...
  },
  {
    ...
    name: "Thighs",
    instruction:
      "Feel the front and back of your thighs. Notice their weight and any sensations.",
    duration: 15000,
  },
  {
    id: "knees",
    name: "Knees & Calves",
    instruction:
      "Scan your knees and calf muscles. Let them be heavy and relaxed.",
    duration: 15000,
  },
  {
    id: "feet",
    name: "Feet & Toes",
    instruction:
      "Feel your feet and toes. Notice their connection to the ground beneath you.",
    duration: 15000,
  },
  {
    id: "whole",
    name: "Whole Body",
    instruction:
      "Take a moment to feel your entire body as one connected whole. Rest in this awareness.",
    duration: 20000,
  },
];
  ...
  return (
    <div className="relative h-48 sm:h-64 w-full flex justify-center items-center overflow-hidden rounded-xl bg-gradient-to-b from-slate-900 to-slate-800 mb-4 sm:mb-6 px-2">
      ...
      <svg viewBox="0 0 200 400" className="h-5/6 w-auto max-w-full opacity-20">
        <path
          d="M100,20 C130,20 160,60 160,120 L180,300 L140,400 L100,350 L60,400 L20,300 L40,120 C40,60 70,20 100,20"
          fill="white"
        />
      </svg>
...
export default function BodyScan() {
    ...
    if (isActive && !isComplete) {
      interval = setInterval(() => {
        setTimeRemaining((time) => {
          if (time <= 100) {
            nextPart();
            return BODY_PARTS[Math.min(currentPart + 1, BODY_PARTS.length - 1)]
              .duration;
          }
          return time - 100;
        });
  ...
  const currentProgress =
    ((currentBodyPart.duration - timeRemaining) / currentBodyPart.duration) *
    100;
    ...
    return (
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12">
          ...
          <h2 className="text-2xl font-semibold mb-3">Scan Complete</h2>
          <p className="mb-8 leading-relaxed">
            Take a moment to rest in the awareness of your whole body. Notice if
  ...
  return (
    <Card className="max-w-md mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Progress */}
        <div className="flex items-center justify-between text-xs uppercase tracking-wider font-medium">
          <span>{currentBodyPart.name}</span>
          <span>
            {currentPart + 1} / {BODY_PARTS.length}
          </span>
        </div>
        ...
        <div className="text-center py-2 min-h-[80px] sm:min-h-[100px] flex flex-col justify-center items-center px-2">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-sm sm:text-base leading-relaxed max-w-xs mx-auto">
