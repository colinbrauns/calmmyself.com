...
const VALUES: ValueOption[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      "Take a tiny step toward a scary task",
      "Ask for help",
    ],
    icon: Shield,
    color: "",
  ...
  },
  {
    ...
    label: "Honesty",
    examples: [
      "Notice and name what you really feel",
      "Admit a limit",
    ...
    return (
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-10 space-y-5">
          ...
          >
            <div
              className={`w-16 h-16 rounded-full ${current.bgColor} bg-opacity-20 flex items-center justify-center mx-auto`}
            >
          ...
          >
            <h3 className="text-xl font-semibold">
              Compass set toward {current.label} \ud83e\udded
            </h3>
            <p className="mt-2 text-sm">
              Even a tiny step in the direction of your values is meaningful.
              You don&apos;t need to be perfect \u2014 just pointed in the right
              direction.
            </p>
          </motion.div>
          {chosenStep && (
            ...
            >
              <p className="text-xs font-bold uppercase mb-1">Your tiny step</p>
              <p className="text-sm">{chosenStep}</p>
            </motion.div>
          )}
      ...
      <CardContent className="space-y-6">
          ...
          {VALUES.map((v) => {
            ...
            return (
              <button
                ...
                className={`p-4 rounded-xl border-2 transition-all text-center space-y-2 ${selected === v.id ? "border-calm-400 bg-calm-50 dark:bg-calm-950/30 shadow-md scale-[1.02]" : "border-gray-200 dark:border-gray-700 hover:border-gray-300"}`}
              >
        ...
        <AnimatePresence mode="wait">
          {current && (
            ...
            >
              <div
                className={`border-l-4 ${current.bgColor} bg-gray-50 dark:bg-gray-800/50 rounded-r-xl p-4`}
              >
              ...
              <div>
                <label className="block text-sm font-medium mb-1">
                  Your chosen step (optional)
                </label>
                <input
                  type="text"
                  className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-calm-500 focus:border-calm-500"
                  placeholder="I will..."
                  value={chosenStep}
