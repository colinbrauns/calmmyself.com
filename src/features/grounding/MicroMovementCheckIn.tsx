...
const PROMPTS = [
  {
    text: "Roll your shoulders gently forward and back a few times.",
    duration: 15,
  },
  { text: "Stretch your fingers wide, then soften your hands.", duration: 12 },
  {
    text: "Press your feet into the floor and notice the contact.",
    duration: 10,
  },
  {
    text: "Gently turn your head side to side within a comfortable range.",
    duration: 15,
  },
  {
    text: "Sit up a little taller, then allow your posture to soften again.",
    duration: 10,
  },
] as const;
    ...
    return (
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12 space-y-5">
          ...
          >
            <h3 className="text-xl font-semibold">Body checked in 💛</h3>
            <p className="mt-2 text-sm">
              Those small movements can make a real difference. Notice how your
              body feels now compared to a minute ago.
            </p>
          </motion.div>
  ...
  return (
    <Card className="max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Small, seated movements to wake up the body
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <motion.div
            ...
            animate={{
              width: `${((index + (phase === "active" ? 1 - timer / prompt.duration : 0)) / PROMPTS.length) * 100}%`,
            }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-xs">
              Move within a range that feels safe for your body. You can skip or
              adapt any step.
            </p>
          </motion.div>
        </AnimatePresence>
        ...
        {phase === "active" && (
          ...
          >
            <motion.div
              ...
              animate={{
                width: `${((prompt.duration - timer) / prompt.duration) * 100}%`,
              }}
