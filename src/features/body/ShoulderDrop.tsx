      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12 space-y-6">
          ...
          <div>
            ...
            <p>
              {TOTAL_CYCLES} cycles complete. Notice how much lower your
              shoulders sit now.
            </p>
          </div>
          ...
          <ShareInline
            title="Shoulder Drop"
            text="Shoulder tension release on CalmMyself"
          />
        </CardContent>
      </Card>
    );
    ...
    <Card className="max-w-md mx-auto">
      <CardHeader className="text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <CardTitle>Shoulder Drop</CardTitle>
        </div>
        <CardDescription>
          Raise, hold, and drop your shoulders — {TOTAL_CYCLES} cycles
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {!isRunning && cycle === 0 && !completed ? (
          ...
          <>
            ...
            <div className="text-center space-y-2">
              <p className="text-2xl font-bold">{PHASES[phaseIdx].name}</p>
              <p>{PHASES[phaseIdx].desc}</p>
        ...
        <div className="text-xs bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-3 rounded-xl">
          This technique works by first deliberately creating tension, then
          releasing it. The contrast helps your body find a deeper state of
          relaxation than it started with.
        </div>
        <ShareInline
          title="Shoulder Drop"
          text="Shoulder tension release on CalmMyself"
