    ...
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            EMDR-inspired bilateral eye movement for processing and calm
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {!isRunning ? (
            <>
              <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 text-sm">
                <p>
                  Follow the dot with your eyes, keeping your head still. Let
                  your gaze move smoothly from side to side.
                </p>
              </div>
            ...
            <>
              <div className="relative w-full h-32 bg-gray-900 dark:bg-gray-950 rounded-xl overflow-hidden flex items-center">
                ...
                {/* Track line */}
                <div
                  className="absolute left-4 right-4 h-px bg-gray-700"
                  style={{ top: "50%" }}
                />
              </div>

              <p className="text-center text-sm">
                Follow the dot with your eyes, keeping your head still
              </p>
