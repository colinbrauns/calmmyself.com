...
const STEPS: Step[] = [
  {
    ...
    body:
      "Gently acknowledge that this moment is painful or difficult. You might silently say: \"This is really hard right now.\"",
  },
  {
    title: 'Remember you are not alone',
    body:
      "Many people struggle in similar ways. You might say: \"Struggle is part of being human. Other people feel this too.\"",
  },
  {
    title: 'Offer yourself kindness',
    body:
      "Choose a simple, kind phrase you can honestly offer yourself. For example: \"May I be gentle with myself in this moment.\"",
  },
]
...
export default function SelfCompassionBreak() {
  ...
  const [selectedPhrase, setSelectedPhrase] = useState<string>(SUGGESTED_PHRASES[0])
