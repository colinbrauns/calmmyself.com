  ...
  return (
    <Card className="max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Follow the sequence of gentle tapping points
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="text-center px-2">
          ...
          <p className="text-xs sm:text-sm">{current.tip}</p>
        </div>

        <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-sm">
          Tap lightly ~7–10 times at each point while breathing slowly. You can
          repeat a calming phrase like “I am safe” or “I can handle this.”
        </div>
      ...
      <div className="px-6 pb-6 pt-0">
        <div className="pt-4 mt-2 border-t border-gray-100 dark:border-gray-800 space-y-3">
          <div className="text-xs bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-3 rounded-xl">
            About: Emotional Freedom Technique (EFT) combines gentle tapping and
            focused phrases; some studies show reductions in anxiety for certain
            groups.
            <br />
            Evidence: Search scholarly databases for “EFT tapping randomized
            trial anxiety”.
          </div>
          <ShareInline
            title="EFT Tapping"
            text="Follow the EFT tapping sequence on CalmMyself"
          />
        </div>
      </div>
    </Card>
