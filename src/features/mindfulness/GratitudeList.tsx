      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="py-10 space-y-6">
          ...
          <ShareInline
            ...
            text="Practice gratitude on CalmMyself"
          />{" "}
        </CardContent>{" "}
      </Card>
    );
    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardHeader className="text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-2">
          {" "}
          <Sun className="w-5 h-5" /> <CardTitle>Gratitude List</CardTitle>{" "}
        </div>{" "}
        <CardDescription>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex justify-center gap-2">
          ...
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className={`w-10 h-1.5 rounded-full transition-colors ${i <= currentIdx ? "bg-amber-500" : "bg-gray-200 dark:bg-gray-700"}`}
            />
          ))}{" "}
        </div>{" "}
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-amber-300 dark:focus:ring-amber-700 text-sm resize-none"
            />{" "}
          </motion.div>{" "}
        </AnimatePresence>{" "}
        <div className="flex justify-center">
          ...
          <Button
            ...
            variant="calm"
            size="lg"
            disabled={!items[currentIdx].trim()}
