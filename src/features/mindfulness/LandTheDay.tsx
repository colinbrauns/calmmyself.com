  ...
  <div className="relative h-40 w-full rounded-xl overflow-hidden mb-6 border border-gray-200 dark:border-gray-700">
    ...
    <motion.div
      ...
      animate={{
        ...
        boxShadow: stepIndex === 2 ? '0 0 30px rgba(251, 191, 36, 0.4)' : '0 0 40px rgba(253, 224, 71, 0.6)',
      }}
      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12 space-y-5">
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Day landed 🌙</h3>
            <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
              You gave this day a gentle close. Tomorrow can wait — tonight, you rest.
            </p>
          </motion.div>
    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          <div className="bg-indigo-400 h-2 rounded-full transition-all duration-300" style={{ width: `${progress}%` }} />
        </div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="space-y-3"
          >
            <h3 className="text-lg font-semibold text-purple-800 dark:text-purple-300 text-center">{step.title}</h3>
            <p className="text-sm text-gray-700 dark:text-gray-300 text-center">{step.prompt}</p>
          ...
          <div className="space-y-2">
            {gratitudes.map((g, i) => (
              <input
                key={i}
                type="text"
                className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
      ...
      <div className="px-6 pb-6 pt-0"><div className="pt-4 mt-2 border-t border-gray-100 dark:border-gray-800">
        <ShareInline title="Land the Day" text="Use a brief Land the Day check‑in before bed on CalmMyself." />
      </div></div>
    </Card>
  )
}
