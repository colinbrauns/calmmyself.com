      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12 space-y-6">
          ...
          <div>
            ...
            <p>
              The cold water activates your vagus nerve, shifting your body
              toward calm. Notice the tingling in your hands.
            </p>
          </div>
          ...
          <ShareInline
            ...
            text="Vagal nerve activation with cold water on CalmMyself"
          />
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card className="max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Run cold water over your hands to activate your vagus nerve
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
            ...
            <div className="flex justify-center gap-2">
              {[30, 45, 60].map((d) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${d === duration ? "bg-blue-600 text-white" : "bg-gray-100 dark:bg-gray-800"}`}
                >
                  {d}s
                </button>
              ))}
            </div>
            <div className="text-sm bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 p-4 rounded-xl space-y-2">
            ...
            <div className="relative w-40 h-40 mx-auto">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <motion.div
                  ...
                  animate={{
                    backgroundColor: `rgba(59, 130, 246, ${0.15 + progress * 0.5})`,
                  }}
        ...
        <div className="text-xs bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-3 rounded-xl">
          Cold water on the hands and wrists stimulates the vagus nerve,
          triggering a parasympathetic response that lowers heart rate and
          reduces anxiety.
        </div>
        <ShareInline
          title="Cold Water Hands"
