...
export default function CoherentBreathing() {
  ...
  return (
    <ToolCard>
      ...
      <ToolBody>
        <ToolStage>
          <div data-testid="tool-visual" className="relative flex items-center justify-center">
            <BreathingCycle
              pattern={PATTERN}
          ...
          <PhaseReadout
            label={currentLabel}
            detail={breath.isComplete ? `Complete: ${MAX_CYCLES} cycles finished` : `Cycle ${cycleLabel} of ${MAX_CYCLES}`}
          />
      ...
      <ToolFooter>
        <EvidenceNote>
          Coherent breathing can support autonomic balance and HRV. Breathe softly without strain.
          <br/>
