    ...
    return (
      <Card className="max-w-md mx-auto">
        <CardContent className="text-center py-12 space-y-5">
          ...
          >
            <h3 className="text-xl font-semibold  ">Wave surfed 🌊</h3>
            <p className="  mt-2 text-sm">
              You rode the wave instead of fighting it. That takes real
              strength. The urge may return — and you can surf it again.
            </p>
          </motion.div>
    ...
    <Card className="max-w-md mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex items-center justify-between text-sm  ">
          ...
          {timerActive && <span className="font-mono text-lg ">{timer}s</span>}
        </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-sm   text-center">{step.body}</p>
          </motion.div>
        </AnimatePresence>
