  ...
  return (
    ...
    >
      ...
      <motion.ellipse
        ...
        transition={{
          duration: 1.5,
          repeat: leftActive && isActive ? Infinity : 0,
        }}
      />
      ...
      <ellipse
        ...
        rx={6}
        ry={4}
        fill={leftActive && isActive ? "#3b82f6" : "#d1d5db"}
        opacity={0.5}
      />
      ...
      <motion.ellipse
        ...
        transition={{
          duration: 1.5,
          repeat: rightActive && isActive ? Infinity : 0,
        }}
      />
      ...
      <ellipse
        ...
        rx={6}
        ry={4}
        fill={rightActive && isActive ? "#f59e0b" : "#d1d5db"}
        opacity={0.5}
      />
      ...
      <text
        ...
        y={175}
        textAnchor="middle"
        fill={leftActive && isActive ? "#3b82f6" : "#9ca3af"}
        fontSize={11}
        fontWeight={leftActive && isActive ? "bold" : "normal"}
      >
        Left
      </text>
      <text
        ...
        y={175}
        textAnchor="middle"
        fill={rightActive && isActive ? "#f59e0b" : "#9ca3af"}
        fontSize={11}
        fontWeight={rightActive && isActive ? "bold" : "normal"}
      >
        Right
      </text>
...
export default function AlternateNostril() {
  ...
  const rightActive =
    current.phase === "inhaleR" || current.phase === "exhaleR";
    ...
    <ToolCard>
      ...
      <ToolBody>
        ...
        <ToolStage>
          <div data-testid="tool-visual" className="relative">
            ...
            <div className="pointer-events-none absolute inset-0 flex items-center justify-center pt-8">
              <div className="rounded bg-white/75 px-2 py-0.5 text-sm font-semibold dark:bg-gray-900/70">
        ...
        <ToolInfo tone="grounding">
          Use your right hand: thumb closes the right nostril, ring finger
          closes the left. Breathe softly.
        </ToolInfo>
      </ToolBody>
      <ToolFooter>
        <EvidenceNote>
        ...
        <ShareInline
          title="Alternate Nostril Breathing"
          text="Try alternate nostril breathing on CalmMyself"
        />
      </ToolFooter>
    </ToolCard>
  );
